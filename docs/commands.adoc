...
// TODO(hbt) NEXT add indication whether a counter is supported by a command
...
// TODO(hbt) NEXT think about breaking it down further
=== Page
|===
|Name|Description
...
// TODO(hbt) NEXT add note quickmark vs mark
...
// TODO(hbt) NEXT include :XXXX commands + think about adding JS equivalent
